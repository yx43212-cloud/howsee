...
- Lower-pressure guided UX: a short Easy Flow note and three text-to-image setup tabs split controls into basic visuals, character settings, and scene/action choices instead of showing every dropdown at once.
