...
- Guardrails that reject underage, non-consensual, voyeuristic, and graphic violence cues; 設友 mode only shows general design presets while 色友 reveals a separate adult-oriented area after confirmation.
...
- 400 explicitly named outfit presets split into male/female 100 normal and 100 adult-oriented sets, plus 200 explicitly named scene presets (100 everyday and 100 mysterious) and 150 accessory/prop presets without visible category tags in the selector labels.
