...
- Text-to-image generation automatically creates 5 AI-judged image-to-video variants with Chinese explanation text for review and separate copyable English prompts; separate image-upload video suggestions still estimate adult-only explicitness 1-10 locally in the browser with selectable score-aware outputs.
