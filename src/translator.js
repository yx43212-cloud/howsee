...
const sensualSpecialBodyFeaturePairs = [
  ['懷孕成人伴侶', 'pregnant adult companion identity, respectful and non-fetishized'],
  ['跛腳成人角色', 'adult character with a limping gait, dignified portrayal'],
  ['合意被虐狂人格', 'consensual masochist personality, non-graphic adult-only framing'],
  ['合意施虐型人格', 'consensual dominant sadist personality, non-graphic adult-only framing'],
  ['佔有慾強烈伴侶', 'strongly possessive adult partner personality, consensual boundaries'],
  ['溫柔照護者', 'gentle caregiver personality'],
  ['病弱美人設定', 'fragile adult beauty persona'],
  ['輪椅使用者', 'adult wheelchair user identity, respectful styling'],
  ['義肢模特', 'adult model with a prosthetic limb, confident styling'],
  ['單眼眼罩角色', 'adult character wearing one eye patch'],
  ['疤痕戰士身份', 'scarred adult warrior identity'],
  ['失憶戀人設定', 'adult amnesiac lover persona'],
  ['寡言保鑣人格', 'quiet adult bodyguard personality'],
  ['危險治療師身份', 'dangerous adult therapist persona'],
  ['神祕寡婦身份', 'mysterious adult widow identity'],
  ['禁慾修女風人格', 'ascetic nun-inspired adult persona'],
  ['墮落天使身份', 'fallen angel adult identity'],
  ['契約惡魔伴侶', 'contract demon adult companion identity'],
  ['吸血鬼眷屬身份', 'adult vampire thrall identity'],
  ['人造人伴侶設定', 'android adult companion persona'],
  ['實驗體倖存者', 'adult experiment survivor identity'],
  ['逃亡貴族身份', 'fugitive adult aristocrat identity'],
  ['秘密間諜人格', 'secret adult spy personality'],
  ['雙面偶像設定', 'dual-persona adult idol identity'],
  ['反差教師身份', 'adult teacher persona with private contrast'],
  ['冷淡上司人格', 'cool adult boss personality'],
  ['忠犬型伴侶', 'devoted puppy-like adult partner personality'],
  ['貓系傲嬌人格', 'catlike tsundere adult personality'],
  ['病嬌但合意設定', 'yandere-inspired adult persona with consent boundaries'],
  ['年上成熟引導者', 'older mature adult guide persona'],
  ['年下主動追求者', 'younger adult proactive pursuer persona'],
  ['離婚後重生身份', 'divorced adult renewal identity'],
  ['單親成人身份', 'single-parent adult identity'],
  ['重逢初戀設定', 'reunited first-love adult persona'],
  ['青梅竹馬成人版', 'childhood-friend adult version persona'],
  ['命定靈魂伴侶', 'destined soulmate adult persona'],
  ['高敏感人格', 'highly sensitive adult personality'],
  ['社交恐懼人格', 'socially anxious adult personality'],
  ['創傷後療癒者', 'adult trauma-healing survivor identity'],
  ['復仇者身份', 'adult avenger identity'],
  ['黑道繼承人身份', 'adult underworld heir identity'],
  ['女王型人格', 'queenlike adult personality'],
  ['臣服型人格', 'submissive adult personality with consent boundaries'],
  ['拜金情人設定', 'materialistic adult lover persona'],
  ['純愛守護者人格', 'pure-love guardian adult personality'],
  ['偏執藝術家身份', 'obsessive adult artist identity'],
  ['流浪詩人身份', 'wandering adult poet identity'],
  ['午夜調酒師身份', 'midnight adult bartender identity'],
  ['危險賽車手身份', 'dangerous adult racer identity'],
  ['溫順人妻氣質', 'gentle married-adult aura']
];
...
bodyFeatures.splice(0, bodyFeatures.length,
  ...
  ...sensualSpecialBodyFeaturePairs.map(([zh, en]) => option(zh, en, 'sensual-special'))
);
